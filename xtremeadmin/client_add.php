            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="col-5">
                            ...
                            if (isset($_POST[cli_submit])) {
                                if ($incluir->adicionar()) {
                                    echo "<div class=\"alert alert-success\"> <i class=\"ti-user\"></i> Cliente registrado com sucesso!
                                        <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\"> <span aria-hidden=\"true\">×</span> </button>
                                    </div>";
                                }else {
                                    echo "<div class=\"alert alert-danger\"> <i class=\"ti-user\"></i> Erro ao registrar o cliente, tente novamente!
                                        <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\"> <span aria-hidden=\"true\">×</span> </button>
                                    </div>";
                                }
                            }   
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Adicionar a base de clientes</h4>
                                <h6 class="card-subtitle">Usamos essa base para fazer suas conexões e gerenciamentos, quanto mais dados, melhor!</h6>
                            </div>
                            <hr>
                            <form class="form-horizontal" method="POST" action="client_add.php">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="fname" name="nome" placeholder="First Name Here">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Sobrenome</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="sobrenome" id="lname" placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="email1" class="col-sm-3 text-right control-label col-form-label">CPF</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="cpf" class="form-control" id="cono2" placeholder="Apenas numeros">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="cono1" class="col-sm-3 text-right control-label col-form-label">Telefone</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="tel" class="form-control" id="cono1" placeholder="Com DDD Ex: 014958405643">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="cono1" class="col-sm-3 text-right control-label col-form-label">E-mail</label>
                                        <div class="col-sm-9">
                                            <input type="email" name="email" class="form-control" id="email1" placeholder="">
                                        </div>
                                    </div>
                                </div>
                                <hr>
                                ...
                                <div class="card-body">
                                    <div class="form-group mb-0 text-right">
                                        <button type="submit" name="cli_submit" class="btn btn-info waves-effect waves-light">Salvar</button>
                                    </div>
                                </div>
                            </form>
                        </div>
