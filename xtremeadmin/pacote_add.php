                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            if (isset($_POST['pac_add'])) {
                                if ($incluir->adicionar()) {
                                    echo "<div class=\"alert alert-success\"> <i class=\"ti-user\"></i> Pacote registrado com sucesso!
                                    <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\"> <span aria-hidden=\"true\">×</span> </button>
                                </div>";
                                }else {
                                echo "<div class=\"alert alert-danger\"> <i class=\"ti-user\"></i> Erro ao registrar o pacote, tente novamente!
                                    <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\"> <span aria-hidden=\"true\">×</span> </button>
                                </div>";
                                }
                            }
                            ?>
                            <form method="POST" action="pacote_add.php">
                                    ...
                                    <h4 class="card-title">Informações basicas do pacote</h4>
                                        <div class="row pt-3">
                                            <div class=" col-md-6 ">
                                                ...
                                                <input type="text" id="firstName" name="pac_nome" class="form-control" placeholder="">                                                  
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <span class="input-group-text"><i class="far fa-user"></i></span>
                                                    <input type="text" id="lastName" name="pac_responsaveis" class="form-control form-control-danger" placeholder="">                                                    
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="pac_rota" rows="2"></textarea>
                                                </div>
                                            </div>
                                            <!--/span-->
                                        <!-- </div> -->
                                        ...
                                        <!-- <div class="row"> -->
                                            ...
                                            <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" id="lastName" name="pac_maximo_vagas" class="form-control form-control-danger" placeholder="">
                                                    <small class="form-control-feedback"> Necessário para análizes futuras. </small> 
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" class="form-control" name="pac_valor" value="R$" placeholder="Valor em reais">
                                    ...
                                    <!-- Saída -->
                                        ...
                                        <h4 class="card-title">Dados de Saída</h4>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="data_saida" class="form-control date-inputmask" id="date-mask" placeholder="">
                                                </div>
                                            </div>
                                        ...
                                        <h4 class="card-title ">Dados de Retorno</h4>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="data_volta" class="form-control date-inputmask" id="date-mask" placeholder="">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Saída -->
                                        <div class="row">
                                            <div class="col-md-3 ">
                                                <div class="form-group">
                                                    <label>CEP</label>
                                                    <input type="text" name="cep_saida" class="form-control">
                                                </div>
                                                </div>
                                                <div class="col-md-3">
                                                <div class="form-group">
                                        ...
                                        <!-- Retorno -->
                                            ...
                                            <div class="col-md-3 ">
                                                <div class="form-group">
                                                    <label>CEP</label>
                                                    <input type="text" name="cep_volta" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Cidade</label>
                                                    <input type="text" name="cidade_volta" class="form-control">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Estado</label>
                                                    <input type="text" name="estado_saida" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="endereco_saida" class="form-control">
                                                </div>
                                            </div>
                                           ...
                                           <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Estado</label>
                                                    <input type="text" name="estado_volta" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Endereco</label>
                                                    <input type="text" name="endereco_volta" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                           <!-- Retorno --> 
