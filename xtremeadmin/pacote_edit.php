...
<body>
            ...
            <!-- <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Adicionar Pacotes</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Adicionar Pacotes</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <?php
                            if (isset($_POST['pac_add'])) {
                                if ($incluir->update()) {
                                    echo "<div class=\"alert alert-success\"> <i class=\"ti-user\"></i> Pacote registrado com sucesso!
                                    <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\"> <span aria-hidden=\"true\">×</span> </button>
                                </div>";
                                }else {
                                echo "<div class=\"alert alert-danger\"> <i class=\"ti-user\"></i> Erro ao editar o pacote, reveja as informações e tente novamente!
                                    <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\"> <span aria-hidden=\"true\">×</span> </button>
                                </div>";
                                }
                            }
                            ?>
                            <form method="POST" action="pacote_edit.php?h=<?php echo $_GET['h'] ?>">
                                

                                
                                <div class="form-body">
                                    <div class="card-body">
                                    <h4 class="card-title">Informações basicas do pacote</h4>
                                        <div class="row pt-3">
                                            <div class=" col-md-6 ">
                                            
                                                <div class="form-group">
                                                <label class="control-label">Nome de Divulgação</label>
                                                
                                                                                                                                      
                                                <input value="<?php echo $incluir->consulta_unitaria('pac_nome',$id); ?>" type="text" id="firstName" name="pac_nome" class="form-control" placeholder="">                                                  
                                            
                                            <small class="form-control-feedback"> O nome que é divulgado este pacote </small> </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-3">
                                                <div class="form-group has-danger"> 
                                                    <label class="control-label">Responsável pelo pacote</label>                                                    
                                                    <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="far fa-user"></i></span>
                                                    <input value="<?php echo $incluir->consulta_unitaria('pac_responsaveis',$id); ?>" type="text" id="lastName" name="pac_responsaveis" class="form-control form-control-danger" placeholder="">                                                    
                                                </div>
                                                <small class="form-control-feedback"> Necessário para análizes futuras. </small> 
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                            <div class="form-group has-danger">
                                                    <label class="control-label">Adicione uma Imagem</label>
                                                    <input value="<?php //$incluir->consulta_unitaria('',$id); ?>" type="file" class="form-control-file" id="inputGroupFile01">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Roteiro da excursão</label>
                                                    <textarea class="form-control" name="pac_rota" rows="2"><?php echo $incluir->consulta_unitaria('pac_rota',$id); ?></textarea>
                                                </div>
                                            </div>
                                            <!--/span-->
                                        <!-- </div> -->
                                        ...
                                        <!-- <div class="row"> -->
                                            <div class="col-md-3">
                                            <div class="form-group has-danger">
                                                    <label class="control-label">Número máximo de vagas</label>
                                                    <input value="<?php echo $incluir->consulta_unitaria('pac_maximo_vagas',$id); ?>" type="text" id="lastName" name="pac_maximo_vagas" class="form-control form-control-danger" placeholder="">
                                                    <small class="form-control-feedback"> Necessário para análizes futuras. </small> 
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group has-danger">
                                                    ...
                                                    <input value="<?php echo $incluir->consulta_unitaria('pac_valor',$id); ?>" type="text" class="form-control" name="pac_valor" value="R$" placeholder="Valor em reais">
                                                    <small class="form-control-feedback"> Necessário para análize. </small> 
                                                </div>
                                            </div>
                                    ...
                                    <!-- Saída -->
                                        ...
                                        <div class="row">
                                        <div class="col-md-6 ">
                                        <h4 class="card-title">Dados de Saída</h4>
                                                <div class="form-group">
                                                    <label>Data de saida <small class="text-muted">dd/mm/aaaa</small></label>
                                                    <input value="<?php echo $incluir->consulta_unitaria('pac_data_saida',$id); ?>" type="text" name="data_saida" class="form-control date-inputmask" id="date-mask" placeholder="">
                                                </div>
                                            </div>
                                        
                                        <!-- Retorno -->                                      
                                        <div class="col-md-6 ml-auto">
                                        <h4 class="card-title ">Dados de Retorno</h4>
                                                <div class="form-group">
                                                    <label>Data de Retorno <small class="text-muted">dd/mm/aaaa</small></label>
                                                    <input value="<?php echo $incluir->consulta_unitaria('pac_data_volta',$id); ?>" type="text" name="data_volta" class="form-control date-inputmask" id="date-mask" placeholder="">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Saída -->
                                        <div class="row">
                                            <div class="col-md-3 ">
                                                <?php
                                                    $array_saida = $incluir->consulta_unitaria('pac_local_saida',$id);
                                                    $array_volta = $incluir->consulta_unitaria('pac_local_volta',$id);

                                                    $cep_saida = $array_saida[0];
                                                    $cidade_saida = $array_saida[1];
                                                    $estado_saida = $array_saida[2];
                                                    $endereco_saida = $array_saida[3];

                                                    $cep_volta = $array_volta[0];
                                                    $cidade_volta = $array_volta[1];
                                                    $estado_volta = $array_volta[2];
                                                    $endereco_volta = $array_volta[3];
                                                ?>
                                                <div class="form-group">
                                                    <label>CEP</label>
                                                    <input value="<?php echo $cep_saida; ?>" type="text" name="cep_saida" class="form-control">
                                                </div>
                                                </div>
                                                <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Cidade</label>
                                                    <input value="<?php echo $cidade_saida; ?>" type="text" name="cidade_saida" class="form-control">
                                                </div>
                                            </div>
                                        ...
                                        <!-- Retorno -->
                                            ...
                                            <div class="col-md-3 ">
                                                <div class="form-group">
                                                    <label>CEP</label>
                                                    <input value="<?php echo $cep_volta; ?>" type="text" name="cep_volta" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Cidade</label>
                                                    <input value="<?php echo $cidade_volta; ?>" type="text" name="cidade_volta" class="form-control">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Estado</label>
                                                    <input value="<?php echo $estado_saida; ?>" type="text" name="estado_saida" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="<?php echo $endereco_saida; ?>" type="text" name="endereco_saida" class="form-control">
                                                </div>
                                            </div>
                                           ...
                                           <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Estado</label>
                                                    <input value="<?php echo $estado_volta; ?>" type="text" name="estado_volta" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Endereco</label>
                                                    <input value="<?php echo $endereco_volta; ?>" type="text" name="endereco_volta" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                           <!-- Retorno --> 
                                        ...
                                        <div class="card-body" >
                                        <center>
                                            <button  type="submit" name="pac_add" class="btn btn-info" > <i class="fa fa-check"></i> Salvar Alterações</button>
                                        </center>
                                        </div>
                                    </div>
                                        <!--/row-->
    ...
    <!-- Mask JavaScript -->
    <script src="xtreme-admin/dist/js/custom.min.js "></script>
    <script src="xtreme-admin/assets/libs/inputmask/dist/min/jquery.inputmask.bundle.min.js"></script>
    <script src="xtreme-admin/dist/js/pages/forms/mask/mask.init.js"></script>
</body>
